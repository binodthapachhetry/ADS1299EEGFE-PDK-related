...
<Library LVVersion="10008000">
	...
	<Item Name="Open/Close" Type="Folder">
		...
		<Item Name="Not A Config Data Refnum.vi" Type="VI" URL="../Not A Config Data Refnum.vi"/>
		<Item Name="Open Config Data (compatibility).vi" Type="VI" URL="../Open Config Data (compatibility).vi"/>
	...
	<Item Name="Private VIs" Type="Folder">
		...
		<Item Name="Common Path to Specific Path.vi" Type="VI" URL="../Common Path to Specific Path.vi"/>
	...
	<Item Name="Read" Type="Folder">
		...
		<Item Name="Read Key (Path).vi" Type="VI" URL="../Read Key (Path).vi"/>
	...
	<Item Name="config.mnu" Type="Document" URL="../config.mnu"/>
</Library>
