...
//! Destroy server 
/*! Performs any actions necessary when the server is destroyed.
 * frees fids, files and anything allocated

\param[in] s Server to destroy 
*/
void estyx_destroy(estyx_server_t *s);
